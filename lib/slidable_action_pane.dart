...
import 'package:inventree/utils/widgets/slidable/slidable.dart';
...
class SlidableScrollActionPane extends StatelessWidget {
  ...
  const SlidableScrollActionPane({Key? key, required this.actionPainel})
      : super(key: key);

  final Widget Function(BuildContext, Widget) actionPainel;
